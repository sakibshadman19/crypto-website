...
const handleSubmit = async(e)=>{
  ...
  return (
    ...
    <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20'>
      ...
      <form onSubmit={handleSubmit}>
        <div className='my-4'>
          ...
          <div className='my-2 w-full relative rounded-2xl shadow-xl'>
            <input onChange={(e)=> setEmail(e.target.value)} className='w-full p-2 bg-primary border border-input rounded-2xl' type="email" name="" id="" />
      ...
      <p> Already have an account? <Link className='text-accent' to="/signup"> Sign in</Link></p>
    </div>
  </div>
  )
}
